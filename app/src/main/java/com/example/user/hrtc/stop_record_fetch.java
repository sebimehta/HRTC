...
public class stop_record_fetch extends AsyncTask<Void ,Void ,Void>
{
    String info ="";
    ...
    protected void onPostExecute(Void aVoid)
    {
        ...
        Stop_record.info1.setText(this.parsed1);
        Stop_record.info2.setText(this.parsed2);
        Stop_record.info3.setText(this.parsed3);
        Stop_record.info4.setText(this.parsed4);
        Stop_record.info5.setText(this.parsed5);
        Stop_record.info6.setText(this.parsed6);
        Stop_record.info7.setText(this.parsed7);
