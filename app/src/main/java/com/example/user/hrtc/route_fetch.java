...
public class route_fetch extends AsyncTask<Void ,Void ,Void>
{
    String info ="";
    ...
    protected void onPostExecute(Void aVoid)
    {
        ...
        Route.data1.setText(this.parsed1);
        Route.data2.setText(this.parsed2);
        Route.data3.setText(this.parsed3);
        Route.data4.setText(this.parsed4);
